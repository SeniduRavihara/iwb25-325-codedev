...
import { Chrome, Eye, EyeOff, Github, Lock, Mail, User, Sparkles, Zap, Rocket, ArrowRight } from "lucide-react";
        ...
        <Card className="w-full max-w-md border-2 border-primary/20 shadow-2xl bg-card/50 backdrop-blur-sm relative overflow-hidden group hover:shadow-primary/25 transition-all duration-500">
          ...
          <CardHeader className="space-y-1 text-center relative z-10">
            ...
            <CardDescription className="text-muted-foreground">
              Join <span className="text-primary font-medium">HackathonPlus</span> and start your coding journey today
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center space-x-2 bg-card/30 backdrop-blur-sm p-3 rounded-lg border border-primary/10">
                <Checkbox
                  id="terms"
